...
face_cascade = cv2.CascadeClassifier('E:\\OpenCV_4.1.0\\opencv\\build\\etc\\haarcascades\\haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('E:\\OpenCV_4.1.0\\opencv\\build\\etc\\haarcascades\\haarcascade_eye.xml')
